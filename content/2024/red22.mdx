...
* [CI-H/CI-HW/HASS Recommendations](https://www.when2meet.com/?9612022-x6V3F)

### Academics@MIT Slidedeck (from Ian Waitz)
* **Academics Orientation 2020.** Slidedeck from the Academics@MIT for MIT Class of 2024 Orientation. ([http](https://firstyear.mit.edu/sites/default/files/Documents/AcademicsOrientation2020.pdf), [ipfs](https://ipfs.io/ipfs/QmXhhJWwpriNNTEgT73hPCZA78sZLgUAYowSx6N3VzB9et))

### Learning management systems (class materials)
Generally, class materials are uploaded to a learning management system (LMS) like [Stellar](https://stellar.mit.edu/), [Canvas](https://canvas.mit.edu/), [MITx](https://lms.mitx.mit.edu), or [LMOD](https://learning-modules.mit.edu).

Homeworks may also be posted and graded using [Gradescope](https://www.gradescope.com/).
...
### Choosing classes
* [Good classes for first year students (not discovery)](https://firstyear.mit.edu/node/8387)
* [First year discovery subjects](https://firstyear.mit.edu/node/8388)
* In course descriptions, the unit numbers e.g. &ldquo;3-0-9&rdquo; have the following _very rough_ meaning
  * First number is number of hours for lectures and recitation
  * Second number is number of hours for labs/design/fieldwork
  * Third number is number of hours for preparation (e.g. homework, readings)

### General Insitute Requirements[^girs]
* [Communication Requirement: CI-H and CI-M](https://registrar.mit.edu/registration-academics/academic-requirements/communication-requirement)
* [REST Requirement](http://catalog.mit.edu/mit/undergraduate-education/general-institute-requirements/#restrequirementtext)

### Majors
* [Undergraduate academic administrators](https://registrar.mit.edu/registration-academics/advising-resources-students/academic-administrators-officers)
* [Double major](https://registrar.mit.edu/registration-academics/academic-requirements/majors-minors/double-majors)
* [Declaring a minor](https://registrar.mit.edu/registration-academics/academic-requirements/majors-minors/declaring-minor)

### Registration
* [Add/Drop/Change Form](https://studentformsandpetitions.mit.edu)

## SG3: Finding a community at MIT

### Pset groups
* [``interstellar.live``](http://www.interstellar.live/). Find out who's in your classes, create pset groups, and work together in lounges.

### Clubs
* [MIT Engage: Organizations](https://engage.mit.edu/organizations)
...
* https://studentlife.mit.edu/support/covid19/staying-well
* https://studentlife.mit.edu/support/covid19/support-services
* https://medical.mit.edu/community/stress-reduction
* https://medical.mit.edu/services/mental-health-counseling/covid-19-resources 

## SG5: Miscellaneous
### Organization
* Make a folder for each semester, and then one for every class
* Try to digitize everything — scan your notes, scan your psets, etc.
* Keep a formula sheet for your classes
* Map a mental map for each class
* Academic calendar
  * https://registrar.mit.edu/calendar
  * https://calendar.google.com/calendar/embed?src=s3jmp6jl18a8dse7aut88jv6765ffru3%40import.calendar.google.com&ctz=America/New_York
...
* Try something new &ndash; college is your time.
* Don't wait for permission &ndash; make your own opportunities and chances.
* Take lots of photos
...
* &ldquo;sometimes instead of partying u should stay in ur room with a fluffy blanket and watch netflix with your roommate with a bottle of wine on a friday night owo&rdquo;
...
* [Student T-pass (MBTA discount)](https://web.mit.edu/facilities/transportation/tpass/students.html). Definitely will have to do the calculation based on the expected number of trips.
...
[^girs]: _General Institute Requirements._ ([http](https://firstyear.mit.edu/academics-exploration/general-institute-requirements-girs))